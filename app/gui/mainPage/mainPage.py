...
"")
        ...
        self.pageWidget.setGeometry(QRect(10, 10, 1181, 701))
...
"background-color: #7E1615;")
        ...
        self.notiTitleLabel.setGeometry(QRect(20, 20, 271, 41))
        self.notiTitleLabel.setStyleSheet(u"font: 700 48pt \"KoHo\";\n"
"color: #7E1615")
        self.scrollArea_2 = QScrollArea(self.notiPage)
        self.scrollArea_2.setObjectName(u"scrollArea_2")
        self.scrollArea_2.setGeometry(QRect(20, 110, 1151, 571))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollAreaNotiContent = QWidget()
        self.scrollAreaNotiContent.setObjectName(u"scrollAreaNotiContent")
        self.scrollAreaNotiContent.setGeometry(QRect(0, 0, 1149, 569))
        self.verticalLayout_4 = QVBoxLayout(self.scrollAreaNotiContent)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.notiDetail = QLabel(self.scrollAreaNotiContent)
        self.notiDetail.setObjectName(u"notiDetail")
        self.notiDetail.setMaximumSize(QSize(10000, 50))
...
"border-radius: 8px")
        ...
        self.scrollArea_2.setWidget(self.scrollAreaNotiContent)
